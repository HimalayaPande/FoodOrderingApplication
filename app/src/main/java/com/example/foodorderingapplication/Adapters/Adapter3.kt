...
class Adapter3(private val context: Context, private val data:List<RestaurantDataModel1>, val clicklistener: OnClickInterface): RecyclerView.Adapter<Adapter3.ImageViewHolder>() {
